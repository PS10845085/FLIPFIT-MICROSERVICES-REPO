...
public class GymFlipFitBookingServiceImpl implements GymFlipFitBookingService {
    ...
    public GymFlipFitBookingServiceImpl(GymFlipFitBookingRepository bookingRepo,
                                        GymFlipFitSlotRepository slotRepo,
                                        GymFlipFitSchedulerRepository scheduleRepo,
                                        GymFlipFitUserRepository userRepo) {
